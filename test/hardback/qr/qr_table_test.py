...
class QrTableTest(unittest.TestCase):
    ...
    def test_small(self):
        self.assertEqual(join_qr(5, 2, 3, fillvalue='fill'), SMALL_RESULT)

    def test_big(self):
        self.assertEqual(join_qr(12, 2, 3), BIG_RESULT)


SMALL_RESULT = """\
<table>
  <tr>
    <td> <img src="x/0.png"/> </td>
    <td> <img src="x/1.png"/> </td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td> <img src="x/6.png"/> </td>
    <td> <img src="x/7.png"/> </td>
  </tr>
  <tr>
